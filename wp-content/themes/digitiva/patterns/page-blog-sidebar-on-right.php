<?php
/**
 * Title: page-blog-sidebar-on-right
 * Slug: digitiva/page-blog-sidebar-on-right
 * Categories: hidden
 * Inserter: no
 */
?>
...
<h1 class="wp-block-heading has-text-align-center"><?php echo __('Blog (Sidebar on Right)', 'digitiva');?></h1>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:columns {"style":{"spacing":{"padding":{"right":"var:preset|spacing|container","left":"var:preset|spacing|container"},"blockGap":{"left":"var:preset|spacing|70"}}},"className":"blog-sidebar-on-right-columns"} -->
<div class="wp-block-columns blog-sidebar-on-right-columns" style="padding-right:var(--wp--preset--spacing--container);padding-left:var(--wp--preset--spacing--container)"><!-- wp:column {"verticalAlignment":"top","width":"70%"} -->
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:70%"><!-- wp:query {"queryId":31,"query":{"perPage":"5","pages":"6","offset":"0","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"enhancedPagination":true,"layout":{"type":"default"}} -->
