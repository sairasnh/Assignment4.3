<?php
/**
 * Title: page-sidebar-on-left
 * Slug: digitiva/page-sidebar-on-left
 * Categories: hidden
 * Inserter: no
 */
?>
...
<div class="wp-block-columns" style="padding-right:var(--wp--preset--spacing--container);padding-left:var(--wp--preset--spacing--container)"><!-- wp:column {"width":"30%"} -->
