<?php
/**
 * Title: page-blog-sidebar-on-left
 * Slug: digitiva/page-blog-sidebar-on-left
 * Categories: hidden
 * Inserter: no
 */
?>
...
<h1 class="wp-block-heading has-text-align-center"><?php echo __('Blog (Sidebar on Left)', 'digitiva');?></h1>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:columns {"style":{"spacing":{"padding":{"right":"var:preset|spacing|container","left":"var:preset|spacing|container"},"blockGap":{"left":"var:preset|spacing|70"}}},"className":"blog-sidebar-on-left-columns"} -->
<div class="wp-block-columns blog-sidebar-on-left-columns" style="padding-right:var(--wp--preset--spacing--container);padding-left:var(--wp--preset--spacing--container)"><!-- wp:column {"width":"30%"} -->
